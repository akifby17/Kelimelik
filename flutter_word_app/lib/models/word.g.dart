...
void _wordSerialize(
  ...
  writer.writeLongList(offsets[2], object.imageByte);
...
Word _wordDeserialize(
  ...
  final object = Word(
    ...
    imageByte: reader.readLongList(offsets[2]),
...
extension WordQueryFilter on QueryBuilder<Word, Word, QFilterCondition> {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteElementEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'imageByte',
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteElementGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteElementLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteElementBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'imageByte',
        0,
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'imageByte',
        0,
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Word, Word, QAfterFilterCondition> imageByteLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension WordQueryWhereDistinct on QueryBuilder<Word, Word, QDistinct> {
  ...
  QueryBuilder<Word, Word, QDistinct> distinctByImageByte() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'imageByte');
    });
  }
...
extension WordQueryProperty on QueryBuilder<Word, Word, QQueryProperty> {
  ...
  QueryBuilder<Word, List<int>?, QQueryOperations> imageByteProperty() {
    return QueryBuilder.apply(this, (query) {
